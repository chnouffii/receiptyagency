      ...
      {activeSection === 'trusted' && (
        ...
        >
          ...
          <p className="text-sm text-gray-500 mb-6">
            Ces noms apparaissent sur la page d'accueil dans la section "Ils nous font confiance" avec un défilement automatique.
          </p>
          ...
          <div className="flex gap-3 mb-6">
            ...
            <button
              ...
              className="flex items-center gap-2 bg-blue-600 hover:bg-blue-500 disabled:opacity-50 disabled:cursor-not-allowed text-white rounded-lg px-4 py-2.5 text-sm font-medium transition-all"
            >
          ...
          <div className="space-y-2">
            {trustedCompanies.length === 0 ? (
              <p className="text-center text-gray-500 py-8">Aucune entreprise ajoutée</p>
            ) : (
          ...
          {trustedCompanies.length > 0 && (
            <p className="text-xs text-gray-600 mt-4">
              {trustedCompanies.length} entreprise(s) • Défilement automatique sur la page d'accueil
            </p>
          )}
        </motion.div>
      )}
