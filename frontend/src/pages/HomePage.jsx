...
import { ArrowRight, Brain, Zap, TrendingUp, HelpCircle, Plus, Minus } from 'lucide-react';
...
export default function HomePage() {
  ...
  return (
    <div data-testid="home-page">
      ...
      {/* FAQ Section */}
      {faqs.length > 0 && (
        <FAQSection faqs={faqs} lang={lang} isDark={isDark} faqRef={faqRef} t={t} />
      )}
    </div>
  );
}

function FAQSection({ faqs, lang, isDark, faqRef, t }) {
