export const translations = {
  fr: {
    ...
    quote: {
      ...
      describe_label: 'Décrivez ce que vous souhaitez automatiser',
      describe_placeholder: "Ex : on ressaisit environ 300 factures fournisseurs par mois à la main dans notre logiciel comptable, et on rate régulièrement des échéances.",
      describe_hint: 'Vos mots suffisent — pas besoin de vocabulaire technique.',
      analyze: 'Analyser mon besoin',
      analyzing: 'Analyse en cours…',
      analysis_title: 'Ce que nous comprenons',
      analysis_hint: 'Vous pouvez corriger la solution et les fonctionnalités à tout moment.',
      or_pick: 'Ou choisissez directement',
      too_short: 'Décrivez votre besoin en quelques mots de plus.',
  ...
  en: {
    ...
    quote: {
      ...
      describe_label: 'Describe what you want to automate',
      describe_placeholder: 'E.g. we manually re-enter about 300 supplier invoices a month into our accounting software, and we regularly miss deadlines.',
      describe_hint: 'Your own words are enough — no technical vocabulary needed.',
      analyze: 'Analyse my need',
      analyzing: 'Analysing…',
      analysis_title: 'What we understand',
      analysis_hint: 'You can change the solution and features at any time.',
      or_pick: 'Or pick directly',
      too_short: 'Please describe your need in a few more words.',
