      ...
      <div className="max-w-7xl mx-auto px-6 py-12 md:py-16">
        <div className="flex flex-col md:flex-row justify-between items-start gap-8">
          ...
          <div className="flex gap-8 text-sm text-gray-500">
            ...
            <Link to="/quote" className="hover:text-gray-300 transition-colors duration-200">{t.nav.quote}</Link>
          </div>
        </div>
        <div className="mt-12 pt-6 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-xs text-gray-600">&copy; {year} Receipty Agency. {t.footer.rights}</p>
          <div className="flex gap-6 text-xs text-gray-600">
            <span className="hover:text-gray-400 cursor-pointer transition-colors duration-200">{t.footer.privacy}</span>
            <span className="hover:text-gray-400 cursor-pointer transition-colors duration-200">{t.footer.terms}</span>
          </div>
        </div>
      </div>
    </footer>
